...
RunKuduCommand -Command "git fetch origin" -Directory $Directory -Username $KuduUsername -Password $KuduPassword -Hostname $KuduHostname -Reference ([ref]$Output)
RunKuduCommand -Command "git clean -df" -Directory $Directory -Username $KuduUsername -Password $KuduPassword -Hostname $KuduHostname -Reference ([ref]$Output)
...
RunKuduCommand -Command "git checkout $ContentBranch" -Directory $Directory -Username $KuduUsername -Password $KuduPassword -Hostname $KuduHostname -Reference ([ref]$Output)